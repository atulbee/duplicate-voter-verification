...
"[project]/src/app/api/voters/report/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        // Call the .NET API
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiServer"].voterReport(body);
        console.log('[voter-report route] Response:', response);
        // Transform the response to match frontend expectations
        const voters = (response.records || []).map((record)=>({
                srNo: record.SrNo,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(transformedResponse, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6dc3d1f._.js.map